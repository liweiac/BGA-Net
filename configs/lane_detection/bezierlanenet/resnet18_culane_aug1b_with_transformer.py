...
with import_from('./'):
    ...
    from configs.lane_detection.common.optims.combineloss import loss
...
train = dict(
    exp_name='resnet18_bezierlanenet_culane-aug2_transformer',
    workers=16,
    batch_size=20,
    checkpoint=None,
    # Device args
...
test = dict(
    ...
    workers=10,
    batch_size=20,
    checkpoint='./checkpoints/resnet18_bezierlanenet_culane-aug2_transformer/model.pt',
    # Device args
    device='cuda',
